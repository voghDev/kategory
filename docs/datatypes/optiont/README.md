...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@5d2062f1))
```
...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@1f8e36a1))
```
...
```kotlin
optTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@1f8e36a1)
```
...
//[Applicative, Functor, FunctorFilter, Monad, MonoidK, SemigroupK]
```
